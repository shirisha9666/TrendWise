...
import { scrapeGoogle, scrapeGoogleNewsRSS, scrapeTrendingContent } from "../config/scraper.js"
...
try {
    ...
    return res.status(200).json({message:"Article fetched Succssefully",article})
